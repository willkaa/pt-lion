...
import { Phone, Mail, MapPin, ArrowRight, Send, CheckCircle, MessageCircle } from "lucide-react";
          ...
          >
            <div>
              ...
              <div className="space-y-6">
                {[
                  { icon: Phone, label: "021-5568-0161", sub: "Senin - Jumat, 08:00 - 17:00" },
                  { icon: MessageCircle, label: "0877-7728-0105", sub: "WhatsApp - Respon cepat" },
                  { icon: Mail, label: "sales@lionsolusi.com", sub: "Respon dalam 24 jam" },
                  { icon: MapPin, label: "Paramount Serpong, Tangerang", sub: "Ruko Tematik Pasar Modern Paramount Serpong Blok P No.27, Gading Serpong, Curug Sangereng, Kelapa Dua, Tangerang, Banten 15810" },
                ].map((item) => (
